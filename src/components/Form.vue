    ...
    >
      ...
      <form>
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
          ...
          <div>
            <h2 class="text-white dark:text-gray-200">Gender</h2>
            <label for="football" class="text-white pr-2.5">Male</label>
            <input id="football" type="radio" />
            <label for="basketball" class="text-white pl-2 pr-2">Female</label>
            <input id="basketball" type="radio" />
            <label for="volleyball" class="text-white pl-2 pr-2">Other</label>
            <input id="volleyball" type="radio" />
          </div>
          <div>
            <label
              class="text-white dark:text-gray-200"
          ...
          <div>
            <h2 class="text-white dark:text-gray-200">Hobbies</h2>
            <label for="football" class="text-white pr-2.5">Football</label>
            <input id="football" type="checkbox" />
            <label for="basketball" class="text-white pl-2 pr-2"
              >Basketball</label
            >
            <input id="basketball" type="checkbox" />
            <label for="volleyball" class="text-white pl-2 pr-2"
              >Volleyball</label
            >
